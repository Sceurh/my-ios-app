  ...
  return (
    <Modal visible={visible} animationType="slide">
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Button title="Я согласен" onPress={async () => {
          const rec = { id: Date.now().toString(), acceptedAt: new Date().toISOString(), textHash: 'v1' };
          await appendAudit({ action: 'consent.accept', details: rec, timestamp: rec.acceptedAt });
          onAccept(rec);
        }} />
      </ScrollView>
    </Modal>
